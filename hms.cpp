...
class HospitalManagementSystem : public PatientBST{
public:
    ...
    void checkOutPatient(string specialization, BSTNode*& root) {
        ...
        root = insertPatientInBST(root, p->id, p->age, p->name, p->disease, specializationMap[specialization].first);
    ...
    while (true) {
        ...
        switch (choice) {
            ...
            case 2: {
                ...
                cout << "Enter Speciality to checkout a Patient\n(Dermatologist,Physician,Neurosurgeon,Opthalmologist,\nOrthopedist,Otolaryngologist,Dentist,Surgeon,Oncologist): ";
                cin >> specialization;
                SetConsoleTextAttribute(hConsole, 10);
                hm.checkOutPatient(specialization, bst.root);
                break;
            }
            case 3: {
                int id;
